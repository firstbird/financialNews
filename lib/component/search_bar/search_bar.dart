...
import 'package:recipe/widgets/text_field/mh_text_field.dart';
...
class _SearchBarState extends State<SearchBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      width: FlutterScreenUtil.ScreenUtil().screenWidth, // todo mzl contact screenWidthDp
      height: 56.0,
      child: Stack(
        ...
        children: <Widget>[
          ...
          AnimatedPositioned(
            top: 0,
            right: _isEdit ? 0 : -1.0 * FlutterScreenUtil.ScreenUtil().setWidth(162.0),
            bottom: 0,
            child: InkWell(
              onTap: _onCancelTap,
              highlightColor: Colors.transparent,
...
class _SearchCube extends StatelessWidget {
  const _SearchCube({Key? key, this.isEdit = false, this.isAnimating = false}) : super(key: key);
