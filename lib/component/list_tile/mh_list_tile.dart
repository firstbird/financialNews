    ...
    return GestureDetector(
      ...
      onLongPress: widget.enabled
          ? () {
              if (widget.onLongPressValue != null &&
                ...
                widget.onTapValue!(context);
              } else if (widget.onLongPress != null && widget.onTap != null &&
      ...
      child: Container(
        height: widget.height == null
            ? null
            : widget.height - (widget.dividerHeight ?? 0.5), //todo mzl height
        // height: 300,
        color: _fetchColor(),
        // padding:
        //     widget.contentPadding ?? EdgeInsets.symmetric(horizontal: 16.0), // todo mzl padding
        child: _buildItem(),
      ),
    );
  }
