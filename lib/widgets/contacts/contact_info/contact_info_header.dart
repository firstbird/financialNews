        ...
        child: InkWell(
          ...
          child: Hero(
            ...
            child: CachedNetworkImage(
              imageUrl: "",// todo mzl contact user.profileImageUrl,
              width: avatarWH,
              height: avatarWH,
              fit: BoxFit.cover,
    ...
    Widget middle = Column(
      ...
      children: <Widget>[
        ...
        Row(
          children: <Widget>[
            Text(
              "test screen name",// todo mzl contact user.screenName
              style: TextStyle(
        ...
        Text(
          '昵称：', // todo mzl contact ${user.remarks}
          style: TextStyle(
              fontSize: ScreenUtil().setSp(45.0), color: Color(0xFF808080)),
        ),
        Text(
          '微信号：', // todo mzl contact ${user.wechatId}
          style: TextStyle(
              fontSize: ScreenUtil().setSp(45.0), color: Color(0xFF808080)),
        ),
        Offstage(
          offstage: Util.isEmptyString(""),// todo mzl contact user.region
          child: Text(
            '地区：', // todo mzl contact ${user.region}
            style: TextStyle(
                fontSize: ScreenUtil().setSp(45.0), color: Color(0xFF808080)),
          ),
        ),
