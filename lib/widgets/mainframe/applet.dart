...
class Applet extends StatefulWidget {
  Applet({Key? key, this.offset = 0, this.refreshing = false, this.onScroll})
      : super(key: key);
...
class _AppletState extends State<Applet> with SingleTickerProviderStateMixin {
  ...
  // 构建一个小程序
  Widget _buildAppletItemWidget({required String iconName, required String title, required int index}) {
    return Column(
