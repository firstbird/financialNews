...
class Avatars extends StatelessWidget {
  /// 构造函数
  const Avatars({Key? key, required this.message}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < length; i++) {
      ...
      final icon = user.profileImageUrl;//todo mzl contact user.profileImageUrl;
      ...
      if (length == 1) {
        ...
        // 3/4
        iconWH = ScreenUtil().setWidth(40);// 63
      } else {
        // 5/6/7/8/9
