...
import 'package:recipe/repository.dart';
...
class AccountService {
  ...
  static AccountService _instance = _getInstance();
  ...
  Future _initAsync() async {
    ...
    _user = SpUtil.getObj(CacheKey.wechatUserDataKey, (m) => User.fromJson(m as Map<String, dynamic>))!;
  ...
  User get currentUser {
    if (_user == null) {
      _user =
          SpUtil.getObj(CacheKey.wechatUserDataKey, (m) => User.fromJson(m as Map<String, dynamic>))!;
    }
    return _user!;
  }
