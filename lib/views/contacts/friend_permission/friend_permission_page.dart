...
import 'package:recipe/widgets/loading_dialog/loading_dialog.dart';
...
class _FriendPermissionPageState extends State<FriendPermissionPage> {
  ...
  /// 选中的Item
  late CommonRadioItem _selectedItem;
  ...
  List<CommonGroup> _configData() {
    ...
    // todo mzl contact
    final preCacheKey = "_currentUser.idstr _user.idstr";//_currentUser.idstr + '_' + _user.idstr + '_';
  ...
  void _itemOnTap(CommonItem i) {
    ...
    if (_selectedItem == null) {
      ...
      Future.delayed(Duration(seconds: 1), () async {
        ...
        _selectedItem = item;
        // todo mzl contact
        final preCacheKey = "_currentUser.idstr";//_currentUser.idstr + '_' + _user.idstr + '_';
        if (item.title == '仅聊天') {
          SpUtil.putString(
