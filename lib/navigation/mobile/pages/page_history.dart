...
class PageHistory extends ConsumerStatefulWidget  {
...
class PageHistoryState extends ConsumerState<PageHistory>
  ...
  Widget getRow(int i) {
    var p = _itemList[i];
    return _HistoryItemView(playlist: p, width: 60, type: 0);
  }
  Widget _contentList() {
