...
import 'package:recipe/navigation/common/material/dialogs.dart';
...
class AlbumFlexibleAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //             try {
    //               // to do 11.17
    //               // final Future<bool> succeed = showLoaderOverlay(context,
    //               //     neteaseRepository!.like(1, like: true));
    //               // succeed.then((suc) => {
    //               //     if (suc) {
    ...
    //               // });
    //
    //               toast(context.strings.todo + " xx store");
    //             } catch (msg) {
    //               // setState(() {
...
class _AppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      automaticallyImplyLeading: false,
      title: Text(t > 0.5 ? "" : context.strings.headlines),
      backgroundColor: Colors.transparent,
