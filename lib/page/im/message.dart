          ...
          Row(
            ...
            children: [
              ...
              TextButton(
                  ...
                  child: Text(
                    '立即购买',style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Global.profile.fontColor),
                  ),
  ...
  Future<void> loadAssets() async {
    ...
    try {
      resultList = await AssetPicker.pickAssets(
        context,
        pickerConfig: AssetPickerConfig(maxAssets: 4, selectedAssets: _images, requestType: RequestType.image),
      );
