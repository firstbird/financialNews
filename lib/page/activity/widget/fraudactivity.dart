...
class _FraudActivityState extends State<FraudActivity> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('欺诈举报', style: TextStyle(color: Colors.black, fontSize: 16)),
        centerTitle: true,
      ),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text('简要描述事件过程', style: TextStyle(color: Colors.black87, fontSize: 14, ),),
          ),
          MyDivider(),
          TextField(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            margin: EdgeInsets.all(10),
            child: Text('举报证据截图', style: TextStyle(color: Colors.black87, fontSize: 14, ),),
          ),
          buildGridView(),
        ],
      )
  ...
  Future<void> loadAssets() async {
    ...
    if(resultList != null && resultList.length != 0){
      ...
      _securityToken = await _aliyunService.getActivitySecurityToken(Global.profile.user!.token!,  Global.profile.user!.uid);
