...
class _MyJoinActivityState extends State<MyJoinActivity> with AutomaticKeepAliveClientMixin{
  ...
  _onLoading() async{
    ...
    if(moredata.length > 0)
      _activityJoinList = _activityJoinList + moredata;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('我加入的活动', style: TextStyle(color: Colors.black, fontSize: 16)),
        centerTitle: true,
      ),
      body: Padding(
        ...
        child: SmartRefresher(
          ...
          child: _refreshController.headerStatus == RefreshStatus.completed && _activityJoinList.length == 0 ? Center(
            child: Text('你还没参加过活动',
