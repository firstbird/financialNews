...
class _BugReportState extends State<BugReport> {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text('描述BUG内容', style:  TextStyle(color: Colors.black87, fontSize: 14, ),),
          ),
          MyDivider(),
          TextField(
    ...
    return Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              margin: EdgeInsets.all(10),
              child: Text('BUG内容截图', style: TextStyle(color: Colors.black87, fontSize: 14, ),),
            ),
            buildGridView(),
          ],
        )
        ...
        onPressed: () async {
          if(Global.profile.user != null) {
            ...
            if(reportid != null && reportid != ""){
              Navigator.pushReplacementNamed(context, '/BugInfo', arguments: {"bugid": reportid});
            }
          }
          else{
  ...
  Future<void> loadAssets() async {
    ...
    _securityToken = await _aliyunService.getBugSecurityToken(Global.profile.user!.token!,  Global.profile.user!.uid);
